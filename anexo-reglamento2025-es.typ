...
3. Motor – Art. 2.2
4. Transmisión / diferencial – Art. 2.3
5. Frenos – Art. 2.5
6. ABS – Art. 2.6
...
Organizador: P21 Motorsport (Cascais, Portugal).
Todos los vehículos deben ser 911 GT3 Cup Tipo 992 de
los años modelo 2021-2025 en la especificación de
fábrica, salvo lo expresamente permitido en este
reglamento.
Los repuestos deben adquirirse únicamente a través de P21
...
autorizada.
• Todo lo no expresamente permitido está prohibido.
• Las piezas desgastadas sólo podrán sustituirse por
piezas Porsche originales con idéntico número de
parte.
...
18.
• Escape de competición con catalizador homologado
DMSB; silenciador estándar obligatorio (ref.
9F1251051A).
•
“Supercup” silenciador (9F1251187) opcional previa
dispensa.
• Kit rápido de llenado de aceite permitido, pero su uso
en boxes durante evento está prohibido.
• Refrigerante: mezcla 22 L agua destilada + 2 L
anticorrosivo Porsche; antihielo prohibido.
• Aceite motor obligatorio: Mobil 1 C40 GT 0W-40 o
Mobil 1 ESP X3 0W-40.
4. TRANSMISIÓN / DIFERENCIAL – Art. 2.3
• Cambio secuencial de 6 velocidades, engranajes dog-
type, lubricación por aceite con intercambiador
aceite-agua.
• Relaciones fijas (ver tabla en original).
• Diferencial de deslizamiento limitado mecánico: 12
superficies de fricción (12 FF).
• Ángulos de rampa: 52 º (tracción) / 35 º (sobre-
marcha).
• Embrague triple disco sinterizado.
• Paddle-shift con actuador electrónico.
...
• Del.: pinzas 6 pistones, discos ventilados ranurados
380 × 32 mm; Tras.: pinzas 4 pistones, idénticas
dimensiones.
• Pastillas de competición ref. 9F1615432 (del.) y
9F1615432B (tras.).
• Spoilers en brazos de suspensión (ref. 9F140/811-812)
obligatorios.
...
link.
• Altura de carrocería, alineación (camber) y
convergencia ajustables dentro de límites:
– Max. espesor arandelas camber delantera: 20 mm;
trasera: 15 mm (incluye espaciador no extraíble).
• Batalla izq./dcha.: 2 468 mm ± 15 mm.
• Antibalance solo se puede desenganchar; no se pueden
añadir piezas.
• Amortiguadores Multimatic y muelles H&R originales;
...
central:
– Del.: 12J × 18 ET 23.5; Tras.: 13J × 18 ET 44.5.
• Solo rines Porsche originales; se permite pintar, salvo
zonas de apoyo.
• Únicos neumáticos permitidos (suministrados por
Michelin):
– Slick: Del. 30/65 R18 Porsche Cup N3, Tras. 31/71
R18 N3R.
– Lluvia: Del. 30/65 R18 P2L, Tras. 31/71 R18 P2L.
• Prohibido rotar neumáticos sobre el rin; recolocación
solo por Michelin oficial.
...
(1,60 × 3,75 m) y tres bidones (amarillo líquido
freno, rojo aceite, azul refrigerante).
• Prohibido verter líquidos al suelo; lavado solo en zona
designada; agua sin jabón preferente.
• Generadores “super-silenciados”, lejos del público;
apagados cuando no sean necesarios.
...
cubiertas.
• Anexo 4: ángulos rampa diferencial 52 º/35 º, 12
discos de fricción (12 FF).
• Anexo 5: puntos de medida altura libre (del. 788 mm,
tras. 2 839 mm y 3 627 mm desde eje).
...
tapas, caja MS 6.6).
• Cualquier trabajo que exija romper precintos solo
puede hacerse en Porsche AG; nuevo precinto
obligatorio.
• Configuración obligatoria durante evento:
– Traction-control y ABS en mapa “Basis” (valor “T”
en log).
...
a) Prevención de vertidos
• Utilizar siempre estera absorbente debajo del coche
cuando se trabaje con líquidos.
• Guardar líquidos peligrosos en contenedores
secundarios (bandeja 110 % del volumen).
b) Limpieza de neumáticos
• Solo agua; si se usa jabón, biodegradable (pH 5-10).
• Recoger todo el agua residual; nunca verter a desagües
sin tratamiento.
c) Residuos
• Separar vidrio, papel, plásticos, metales según
contenedores del circuito.
• Neumáticos usados quedan bajo responsabilidad del
equipo/fabricante.
d) Generadores
• Ubicar lejos del público, con pantalla acústica, tamaño
óptimo y apagados cuando no se necesiten.
e) Salida del evento
• Retirar carteles, limpiar el paddock, depositar residuos
...
• Altura libre: medir en plancha oficial; puntos 788 mm
(del.) y 2 839 / 3 627 mm (tras.).
• Lastre: posición derecha delantera sobre placa auxiliar
(asiento pasajero); piezas 2 kg, 3,5 kg, 6,8 kg.
• Camber: máx 20 mm (del.) / 15 mm (tras.) de
arandelas; espaciador trasero fijo 9F1.505.184
incluido.
• Escape: silenciador base 9F1251051A; opcional
“Supercup” 9F1251187 (previa dispensa).
• Neumáticos: slick 30/65-31/71 R18; lluvia 30/65-
31/71 R18 P2L; marcados por Michelin.