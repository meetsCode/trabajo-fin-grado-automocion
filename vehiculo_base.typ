...
Nuestro interés es de disponer del repuesto para el caso del desgaste o rotura.
...
- Transmisión
*Frenos*
- Desgaste de discos y pastillask- Temperaturas alcanzadas
*Neumáticos*
- Desgaste irregular
...
CONCLUSIÓN 
      ...
      - El mantenimiento total de un coche GT3 puede superar fácilmente los 30.000 € por temporada solo en piezas
      - Si hay accidentes o averías, el coste aumenta muchísimo.
